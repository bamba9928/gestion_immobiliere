...
# Personnalisation de l'en-tête de l'admin
...
class BienAdmin(admin.ModelAdmin):
    ...
    def etat_badge(self, obj):
        # Utilise la propriété calculée 'est_occupe' du modèle
        if obj.est_occupe:
            return format_html('<span style="color:red; font-weight:bold;">OCCUPÉ</span>')
